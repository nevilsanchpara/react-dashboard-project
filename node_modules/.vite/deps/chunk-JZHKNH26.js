...
} from "./chunk-3RID2X5Y.js";
import {
  require_prop_types
} from "./chunk-NTS6Y3BR.js";
import {
  _extends
} from "./chunk-EW7QTPRE.js";
import {
  require_jsx_runtime
} from "./chunk-OJHDAPMW.js";
import {
  require_react_dom
} from "./chunk-VEK2Y2Y7.js";
import {
  require_react
...
function useCompoundParent() {
  ...
  const registerItem = React21.useCallback(function registerItem2(id, item, missingKeyGenerator) {
...
var _excluded6 = ["anchorEl", "children", "component", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "slotProps", "slots", "TransitionProps", "ownerState"];
...
var _excluded7 = ["actions", "anchorEl", "children", "component", "defaultOpen", "listboxId", "onOpenChange", "open", "slotProps", "slots"];
...
function useCompoundItem(id, itemMetadata, missingKeyGenerator) {
  ...
  const [registeredId, setRegisteredId] = React27.useState(id);
  useEnhancedEffect_default(() => {
    const {
      id: returnedId,
      deregister
...
var ModalUnstyled = React30.forwardRef(function ModalUnstyled2(props, forwardedRef) {
...
function useSelect(props) {
  ...
  const handleStateChange = React35.useCallback((e, field, fieldValue) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(fieldValue);
  ...
  const getOptionMetadata = React35.useCallback((optionValue) => options.get(optionValue), [options]);
  const getListboxProps = (otherHandlers = {}) => {
...
var SliderUnstyled = React39.forwardRef(function SliderUnstyled2(props, ref) {
...
var SnackbarUnstyled = React41.forwardRef(function SnackbarUnstyled2(props, ref) {
  const {
    autoHideDuration = null,
    children,
    component,
...
var SwitchUnstyled = React43.forwardRef(function SwitchUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime29.jsxs)(Root, _extends({}, rootProps, {
    children: [(0, import_jsx_runtime28.jsx)(Track, _extends({}, trackProps)), (0, import_jsx_runtime28.jsx)(Thumb, _extends({}, thumbProps)), (0, import_jsx_runtime28.jsx)(Input, _extends({}, inputProps))]
  }));
});
...
var TablePaginationActionsUnstyled = React44.forwardRef(function TablePaginationActionsUnstyled2(props, ref) {
...
var TablePaginationUnstyled = React45.forwardRef(function TablePaginationUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime32.jsx)(Root, _extends({}, rootProps, {
    children: (0, import_jsx_runtime33.jsxs)(Toolbar, _extends({}, toolbarProps, {
      ...
      })), rowsPerPageOptions.length > 1 && (0, import_jsx_runtime32.jsx)(Select, _extends({}, selectProps, {
...
var Context = React47.createContext(null);
if (true) {
...
var TabsUnstyled = React49.forwardRef(function TabsUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    orientation = "horizontal",
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React51.useCallback((tabValue) => {
    var _subitems$get;
    return (_subitems$get = subitems.get(tabValue)) == null ? void 0 : _subitems$get.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React51.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React51.useCallback((tabValue) => {
  ...
  const handleChange = React51.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React51.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React51.useCallback((item) => {
...
var TabsListUnstyled = React53.forwardRef(function TabsListUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    component,
...
function useTab(parameters) {
  ...
  const tabRef = React54.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
  ...
  const tabMetadata = React54.useMemo(() => ({
    disabled,
    ref: tabRef,
    id
  }), [disabled, tabRef, id]);
...
var TabUnstyled = React55.forwardRef(function TabUnstyled2(props, ref) {
  var _ref;
  const {
    children,
    disabled = false,
...
var TextareaAutosize = React56.forwardRef(function TextareaAutosize2(props, ref) {
  const {
    onChange,
    maxRows,
    minRows = 1,
  ...
  const shadowRef = React56.useRef(null);
  const renders = React56.useRef(0);
  const [state, setState] = React56.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React56.useCallback(() => {
  ...
  return (0, import_jsx_runtime41.jsxs)(React56.Fragment, {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-JZHKNH26.js.map
