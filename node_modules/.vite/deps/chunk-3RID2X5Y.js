...
function useCurrentColorScheme(options) {
  ...
  const handleMediaQuery = React19.useCallback((e) => {
...
function createCssVarsProvider(options) {
  ...
  const useColorScheme = () => {
    const value = React20.useContext(ColorSchemeContext);
    if (!value) {
  ...
  function CssVarsProvider({
    ...
    const element = (0, import_jsx_runtime9.jsxs)(React20.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime9.jsxs)(React20.Fragment, {
...
function createGrid(options = {}) {
  ...
  const OverflowContext = React22.createContext(void 0);
  ...
  const Grid2 = React22.forwardRef(function Grid3(inProps, ref) {
    ...
    const overflow2 = React22.useContext(OverflowContext);
    const {
      className,
      children,
    ...
    let result = (0, import_jsx_runtime11.jsx)(GridRoot, _extends({
      ...
      children: React22.Children.map(children, (child) => {
        if (React22.isValidElement(child) && isMuiElement(child, ["Grid"])) {
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-3RID2X5Y.js.map
